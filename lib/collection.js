...
function BedquiltCollection(client, collectionName) {
  ...
  this.count = function(queryDoc, callback) {
    return this.client._query(
      "select bq_count($1::text, $2::json) as bq_result;",
  ...
  this.insert = function(doc, callback) {
    return this.client._query(
      "select bq_insert($1::text, $2::json) as bq_result;",
  ...
  this.save = function(doc, callback) {
    return this.client._query(
      "select bq_save($1::text, $2::json) as bq_result;",
      [this.collectionName, doc],
      project.single(),
      callback
    );
  ...
  this.find = function(queryDoc, options, callback) {
    ...
    return this.client._query(
      "select bq_find($1::text, $2::json, $3::integer, $4::integer, $5::json) as bq_result;",
  ...
  this.findOne = function(queryDoc, options, callback) {
    ...
    return this.client._query(
      "select bq_find_one($1::text, $2::json, $3::integer, $4::json) as bq_result;",
  ...
  this.remove = function(queryDoc, callback) {
    return this.client._query(
      "select bq_remove($1::text, $2::json) as bq_result;",
      [this.collectionName, queryDoc],
      project.single(),
      callback
    );
  ...
  this.removeOne = function(queryDoc, callback) {
    return this.client._query(
      "select bq_remove_one($1::text, $2::json) as bq_result;",
      [this.collectionName, queryDoc],
      project.single(),
      callback
    );
  ...
  this.addConstraints = function(specDoc, callback) {
    return this.client._query(
      "select bq_add_constraints($1::text, $2::json) as bq_result;",
  ...
  this.removeConstraints = function(specDoc, callback) {
    return this.client._query(
      "select bq_remove_constraints($1::text, $2::json) as bq_result;",
      [this.collectionName, specDoc],
      project.single(),
      callback
    );
